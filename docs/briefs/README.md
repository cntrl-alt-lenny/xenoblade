...
| 044 | [`scaffolder-scngroup-double-define-investigate`](044-scaffolder-scngroup-double-define-investigate.md) | Confirm + document the stale-asm artifact the decomper flagged in PR #44's notes (`ScnGroup` defined twice in `build/us/asm/`); add troubleshooting note to AGENTS.md. | Closed (PR #45) |
| 045 | [`decomper-g3d-anmclr-flip-retry-2`](045-decomper-g3d-anmclr-flip-retry-2.md) | Retry the `g3d_anmclr.cpp` flip (NonMatching → Matching, US) now that brief 042 (PR #43) cleared the `.sdata 0x80663458` over-claim. | Closed (PR #46 — per-TU 100% but +8 .sdata cascade from inline policyTable; deferred to brief 048) |
| 046 | [`scaffolder-hoist-playpolicytable`](046-scaffolder-hoist-playpolicytable.md) | Move `policyTable` out of inline `GetAnmPlayPolicy` in `g3d_anmobj.h` so non-`g3d_anmobj` TUs stop emitting their own 8-byte copy. Unblocks brief 048. | Open |
| 047 | [`decomper-vtable-rename-wave-3`](047-decomper-vtable-rename-wave-3.md) | Third wave of vtable renames using PR #42's detector. Target 25 from the ~264 remaining candidates. | Open |
