...
| 042 | [`scaffolder-anmclr-sdata-uncarve`](042-scaffolder-anmclr-sdata-uncarve.md) | Drop `g3d_anmclr.cpp`'s `.sdata` carve (over-claimed `lbl_eu_80663458`); absorb back into `nw4r_dataa.s`. | Open |
| 043 | [`decomper-vtable-rename-wave-2`](043-decomper-vtable-rename-wave-2.md) | Use PR #42's new vtable detector to find + rename 10–25 more vtable placeholders in `config/us/symbols.txt`. | Open |
