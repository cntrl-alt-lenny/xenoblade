...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "function-count-gain check (brief 039 Part A). Without this "
            "flag the gain summary is omitted."
        ),
    )
    parser.add_argument(
        "--require-gain",
        ...
        default=None,
        help=(
            "Exit code 1 if the function-count gain is below N (brief 039 "
            "Part A). Useful as a hard filter in pipelines: "
